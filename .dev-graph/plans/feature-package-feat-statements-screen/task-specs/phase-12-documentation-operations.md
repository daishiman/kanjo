# System task overlay: docs と運用記述の同期
...
区分の固定対応表・計算式・CF 原因の判定規則、migration 0045 の列と表、画像との意図的な差 (仕様 §8) を docs へ最終同期する。
...
- Operations: applicable: migration 0045 の適用手順と確認方法を書く
