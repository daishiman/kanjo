# System task overlay: 変更全体の最終レビュー

> **正本ではない。** 本書は system-dev-planner が生成した staging snapshot で、promotion 済みの正本は tasks/feat-improvement-request/SYS-IMPREQ-P10.md である。内容の更新はそちらへ入れる。
...
- Write scope: .dev-graph/plans/feature-package-feat-improvement-request/evidence/phase-10-final-review.json
...
- Automated commands: 変更ファイル一覧を write scope の和と突き合わせ、範囲外の変更が0件であることを確認する / scope_out 8件を1件ずつ確認し、該当する変更が0件であることを確認する
