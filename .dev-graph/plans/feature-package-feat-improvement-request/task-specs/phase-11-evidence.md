...
> **正本ではない。** 本書は system-dev-planner が生成した staging snapshot で、promotion 済みの正本は tasks/feat-improvement-request/SYS-IMPREQ-P11.md である。内容の更新はそちらへ入れる。
...
- Write scope: .dev-graph/plans/feature-package-feat-improvement-request/evidence/phase-11-evidence-index.json
...
- Automated commands: 索引の各項目が実在するファイルを指していることを確認する / 証跡ファイルを走査し、口座明細と金額の実データおよび認証情報が含まれないことを確認する
