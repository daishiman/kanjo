# System task overlay: ファイルの状態・上限値・取込可否・要約・エラー文言の規則表の docs 最終同期
...
docs/import-screen/ の規則表を実装と一致させ、データスキーマと UI 決定の文書へ 0050 の表と列、画面の決定を反映する。
...
- docs/data-schema.md に 0050 の表と列が載っている。
- Automated commands:
- pnpm lint
- pnpm test
- Required evidence:
