...
export const APP_ROUTES = [
  ...
  },
  {
    ...
    path: '/settings',
    label: '設定',
    task: '集計ルール・名義・統計・現金上書きと、設定の書き出し・復元・バックアップを管理します。',
    taskDetail:
      '勘定科目と取引先の表記ゆれをまとめる集計ルール、名義の表示名、統計の最小月数、現金上書きを 1 回の保存で管理し、設定だけの JSON の書き出しと復元、夜間バックアップとの比較と設定の復元を行う。未記帳月の扱いもここで決める。',
