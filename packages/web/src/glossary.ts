...
export const GLOSSARY = {
  ...
  yoy: {
    term: '前年同月比',
    short: '同じ月の1年前と比べた増減。季節で動く科目を月どうしで比べられる。',
    desc: '前月比は季節の影響をそのまま拾う(冬の光熱費は毎年上がる)。同じ月の前年と比べると、季節ではなく今年固有の変化だけが残る。前年同月が未記帳、または0のときは比べる相手がいないので空欄。',
    aliases: ['前年同期比', '前年同月', '前年対比', '前年比'],
    abbr: { abbr: 'YoY', full: 'Year over Year', ja: '前年同月比' },
  },
...
export const GUIDE_SECTIONS: readonly GuideSection[] = [
  ...
  },
  {
    ...
    ids: ['judge', 'signal', 'classification', 'fixedCost', 'variance', 'landing'],
  },
  {
    title: 'サブスクと家計',
