/**
 * migration 0050 (データ取込画面) は追加だけで、既存の行を 1 件も書き換えない (SYS-IMPORT-P04)。
 * 0008 の import_runs に既存の行を置いてから 0050 を当て、文ごとの changes の合計が 0 であることと、
...
const sql = readFileSync(resolve(root, 'migrations/0050_import_inspections.sql'), 'utf8');
