...
- hoverは「押せる候補」、pressed/focusは「いま操作している対象」、入場は「追加された場所」、progressは「処理の継続」を伝える。見た目の動きだけを目的にしない。時間・CSS・reduced-motionの正本は jp-web-design `references/motion-a11y.md`。
