---
acceptance: ["P01 から P10 までの各 phase の証跡が索引から辿れ、欠落が0件である", "証跡に実データと秘密情報が含まれていない", "画面の証跡が合成データまたは既存の匿名表示のみで構成されている"]
architecture_refs: ["arch-improvement-request-pipeline"]
artifact_kind: "task"
artifact_subtypes: []
beads_linkage: {"bd_issue_id": "kanjo-8zc", "github_mirror": null, "linked_at": "2026-08-30T13:04:20Z", "sync_state": "synced"}
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-improvement-request/SYS-IMPREQ-P11.md", "confidence": 1}]
...
depends_on: ["SYS-IMPREQ-P10"]
domain: "documentation"
evaluation_status: "pass"
execution_contexts: []
feature_package_id: "feature-package/feat-improvement-request"
file_path: "tasks/feat-improvement-request/SYS-IMPREQ-P11.md"
github_project_linkages: []
github_publication: {"labels": [], "milestone": null, "mode": "local_only", "project_aliases": []}
goal: "後から第三者が判断を再現できるよう、検証結果と受入判定と設計根拠を1か所へ集約する。"
graph_node_id: "SYS-IMPREQ-P11"
...
purpose: "証跡の収集と保全の完了状態と検証可能な証跡を確定する。"
related_nodes: ["arch-improvement-request-pipeline"]
resource_scope: [".dev-graph/plans/feature-package-feat-improvement-request/evidence/phase-11-evidence-index.json"]
scope_in: [".dev-graph/plans/feature-package-feat-improvement-request/evidence/phase-11-evidence-index.json"]
...
source_lineage: {"imported_at": "2026-08-30T12:47:55Z", "origin_kind": "system-dev-planner", "source_digest": "e5aaef0b452885b06b9210c427c16a97c47e85a0a1c9716a17e183e53f08cf07", "source_path": ".dev-graph/plans/feature-package-feat-improvement-request/task-specs/phase-11-evidence.md", "source_plugin": "system-dev-planner", "source_version": "0.1.0"}
start_date: null
status: "active"
...
> **この文書が正本。** `.dev-graph/plans/feature-package-feat-improvement-request/task-specs/phase-11-evidence.md` はこれを生成した staging snapshot で、promotion 後の更新は本書だけに入れる(`source_lineage.source_digest` は promotion 時点の対応を示すもので、以後の同期は保証されない)。

## 目的

後から第三者が判断を再現できるよう、検証結果と受入判定と設計根拠を1か所へ集約する。
...
- P01 から P10 までの各 phase の証跡が索引から辿れ、欠落が0件である
- 証跡に実データと秘密情報が含まれていない
- 画面の証跡が合成データまたは既存の匿名表示のみで構成されている
- 充足状況の最新は feature `features/feat-improvement-request.md` の受入節を見る。

## 入力と前提条件

- 前提: P10 SYS-IMPREQ-P10 が完了していること
...
- 入力: `.dev-graph/plans/feature-package-feat-improvement-request/task-specs/phase-11-evidence.md`
...
- Produced artifacts: .dev-graph/plans/feature-package-feat-improvement-request/evidence/phase-11-evidence-index.json
...
- `touches`: .dev-graph/plans/feature-package-feat-improvement-request/evidence/phase-11-evidence-index.json
- 排他資源: `SYS-IMPREQ-P11`
...
- PR linkage requirement: PR 本文へ beads 識別子と `dev-graph: SYS-IMPREQ-P11` を記載する
...
- 検証: 索引の各項目が実在するファイルを指していることを確認する
- 検証: 証跡ファイルを走査し、口座明細と金額の実データおよび認証情報が含まれないことを確認する
...
- Rollback trigger and steps: 索引ファイルを削除すれば元に戻る。参照先の証跡には影響しない。
