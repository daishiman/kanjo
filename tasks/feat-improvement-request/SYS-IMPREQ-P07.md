---
acceptance: ["受入条件15件それぞれに、判定結果と根拠となる検証名または観測結果が対応づいている", "未達の受入条件が0件である", "画面での手動確認の手順と結果が、実データを含まない形で記録されている"]
architecture_refs: ["arch-improvement-request-pipeline"]
artifact_kind: "task"
artifact_subtypes: []
beads_linkage: {"bd_issue_id": "kanjo-mcx", "github_mirror": null, "linked_at": "2026-08-30T13:04:20Z", "sync_state": "synced"}
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-improvement-request/SYS-IMPREQ-P07.md", "confidence": 1}]
...
depends_on: ["SYS-IMPREQ-P06"]
domain: "quality"
evaluation_status: "pass"
execution_contexts: []
feature_package_id: "feature-package/feat-improvement-request"
file_path: "tasks/feat-improvement-request/SYS-IMPREQ-P07.md"
github_project_linkages: []
github_publication: {"labels": [], "milestone": null, "mode": "local_only", "project_aliases": []}
goal: "実装と検証の結果を受入条件へ突き合わせ、機能として成立しているかを判定する。"
...
purpose: "受入条件15件の判定の完了状態と検証可能な証跡を確定する。"
related_nodes: ["arch-improvement-request-pipeline"]
resource_scope: [".dev-graph/plans/feature-package-feat-improvement-request/evidence/phase-07-acceptance.json"]
scope_in: [".dev-graph/plans/feature-package-feat-improvement-request/evidence/phase-07-acceptance.json"]
...
source_lineage: {"imported_at": "2026-08-30T12:47:55Z", "origin_kind": "system-dev-planner", "source_digest": "e5aaef0b452885b06b9210c427c16a97c47e85a0a1c9716a17e183e53f08cf07", "source_path": ".dev-graph/plans/feature-package-feat-improvement-request/task-specs/phase-07-acceptance.md", "source_plugin": "system-dev-planner", "source_version": "0.1.0"}
start_date: null
status: "active"
...
> **この文書が正本。** `.dev-graph/plans/feature-package-feat-improvement-request/task-specs/phase-07-acceptance.md` はこれを生成した staging snapshot で、promotion 後の更新は本書だけに入れる(`source_lineage.source_digest` は promotion 時点の対応を示すもので、以後の同期は保証されない)。
...
- 前提: P06 SYS-IMPREQ-P06 が完了していること
...
- 入力: `.dev-graph/plans/feature-package-feat-improvement-request/task-specs/phase-07-acceptance.md`
...
- `touches`: .dev-graph/plans/feature-package-feat-improvement-request/evidence/phase-07-acceptance.json
- 排他資源: `SYS-IMPREQ-P07`
...
- PR linkage requirement: PR 本文へ beads 識別子と `dev-graph: SYS-IMPREQ-P07` を記載する
...
- 検証: 受入条件15件の判定表を作り、根拠が空の行が0件であることを確認する
- 検証: ローカルで画面を起動し、改善要望の投稿から指示文コピーまでを通しで実行して結果を記録する
