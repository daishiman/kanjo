---
acceptance: ["本番 D1 のスキーマ整合が回復しているかどうかの判定結果が記録されている", "回復していない場合、本番への migration 適用を実行せず、feat-prod-d1-schema-recovery の完了を待つ判断が記録されている", "ローカルとテスト環境での完成が配信保留によって妨げられていないことが記録されている"]
architecture_refs: ["arch-improvement-request-pipeline"]
artifact_kind: "task"
artifact_subtypes: []
beads_linkage: {"bd_issue_id": "kanjo-maz", "github_mirror": null, "linked_at": "2026-08-30T13:04:20Z", "sync_state": "synced"}
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-improvement-request/SYS-IMPREQ-P13.md", "confidence": 1}]
...
depends_on: ["SYS-IMPREQ-P12"]
domain: "operations"
evaluation_status: "pass"
execution_contexts: []
feature_package_id: "feature-package/feat-improvement-request"
file_path: "tasks/feat-improvement-request/SYS-IMPREQ-P13.md"
github_project_linkages: []
github_publication: {"labels": [], "milestone": null, "mode": "local_only", "project_aliases": []}
goal: "本番配信の前提が満たされているかを判定し、満たされていない場合は配信せず条件を明示して保留する。"
...
purpose: "配信条件の確定と保留判断の完了状態と検証可能な証跡を確定する。"
related_nodes: ["arch-improvement-request-pipeline"]
resource_scope: [".dev-graph/plans/feature-package-feat-improvement-request/evidence/phase-13-release-gate.json"]
scope_in: [".dev-graph/plans/feature-package-feat-improvement-request/evidence/phase-13-release-gate.json"]
...
source_lineage: {"imported_at": "2026-08-30T12:47:55Z", "origin_kind": "system-dev-planner", "source_digest": "e5aaef0b452885b06b9210c427c16a97c47e85a0a1c9716a17e183e53f08cf07", "source_path": ".dev-graph/plans/feature-package-feat-improvement-request/task-specs/phase-13-release-deploy.md", "source_plugin": "system-dev-planner", "source_version": "0.1.0"}
start_date: null
status: "active"
...
> **この文書が正本。** `.dev-graph/plans/feature-package-feat-improvement-request/task-specs/phase-13-release-deploy.md` はこれを生成した staging snapshot で、promotion 後の更新は本書だけに入れる(`source_lineage.source_digest` は promotion 時点の対応を示すもので、以後の同期は保証されない)。
...
- 前提: P12 SYS-IMPREQ-P12 が完了していること
...
- 入力: `.dev-graph/plans/feature-package-feat-improvement-request/task-specs/phase-13-release-deploy.md`
...
- `touches`: .dev-graph/plans/feature-package-feat-improvement-request/evidence/phase-13-release-gate.json
- 排他資源: `SYS-IMPREQ-P13`
...
- PR linkage requirement: PR 本文へ beads 識別子と `dev-graph: SYS-IMPREQ-P13` を記載する
...
- 検証: 本番 D1 の適用済み migration 一覧を確認し、BACKUP_SNAPSHOT_SQL が参照するテーブルの有無を判定する
- 検証: 判定結果に応じて配信または保留のいずれを選んだかと、その根拠を証跡へ記録する
...
- 次に利用するノード: なし (本 feature の最終 phase)
