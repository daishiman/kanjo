---
acceptance: ["利用者向けに、改善要望の送り方と添付が30日で消えることが平易な言葉で書かれている", "運用向けに、削除ジョブの相乗り先と失敗時の確認手順が書かれている", "既存 docs の記述と重複せず、既存文書を正本として参照している"]
architecture_refs: ["arch-improvement-request-pipeline"]
artifact_kind: "task"
artifact_subtypes: []
beads_linkage: {"bd_issue_id": "kanjo-fs9", "github_mirror": null, "linked_at": "2026-08-30T13:04:20Z", "sync_state": "synced"}
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-improvement-request/SYS-IMPREQ-P12.md", "confidence": 1}]
...
depends_on: ["SYS-IMPREQ-P11"]
domain: "documentation"
evaluation_status: "pass"
execution_contexts: []
feature_package_id: "feature-package/feat-improvement-request"
file_path: "tasks/feat-improvement-request/SYS-IMPREQ-P12.md"
github_project_linkages: []
github_publication: {"labels": [], "milestone": null, "mode": "local_only", "project_aliases": []}
goal: "利用者が改善要望を送る手順と、運用側が削除ジョブと保持期間を扱う手順を文書化する。"
...
purpose: "利用手順と運用手順の記載の完了状態と検証可能な証跡を確定する。"
related_nodes: ["arch-improvement-request-pipeline"]
resource_scope: ["docs/improvement-request.md", "docs/ci-cd-operations.md"]
scope_in: ["docs/improvement-request.md", "docs/ci-cd-operations.md"]
...
source_lineage: {"imported_at": "2026-08-30T12:47:55Z", "origin_kind": "system-dev-planner", "source_digest": "e5aaef0b452885b06b9210c427c16a97c47e85a0a1c9716a17e183e53f08cf07", "source_path": ".dev-graph/plans/feature-package-feat-improvement-request/task-specs/phase-12-documentation-operations.md", "source_plugin": "system-dev-planner", "source_version": "0.1.0"}
start_date: null
status: "active"
...
> **この文書が正本。** `.dev-graph/plans/feature-package-feat-improvement-request/task-specs/phase-12-documentation-operations.md` はこれを生成した staging snapshot で、promotion 後の更新は本書だけに入れる(`source_lineage.source_digest` は promotion 時点の対応を示すもので、以後の同期は保証されない)。
...
- 前提: P11 SYS-IMPREQ-P11 が完了していること
...
- 入力: `.dev-graph/plans/feature-package-feat-improvement-request/task-specs/phase-12-documentation-operations.md`
...
- `touches`: docs/improvement-request.md、docs/ci-cd-operations.md
- 排他資源: `SYS-IMPREQ-P12`
...
- PR linkage requirement: PR 本文へ beads 識別子と `dev-graph: SYS-IMPREQ-P12` を記載する
...
- 検証: 追加した記述が既存 docs の内容を複製していないことを確認する
- 検証: 記載した手順どおりにローカルで操作し、記述と実際の画面と応答が一致することを確認する
