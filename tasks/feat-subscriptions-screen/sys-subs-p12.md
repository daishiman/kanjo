...
iteration: null
owners: ["daishiman"]
tags: ["subscriptions-screen", "p12", "documentation-operations"]
file_path: "tasks/feat-subscriptions-screen/sys-subs-p12.md"
template_id: "task"
...
source_lineage: {"imported_at": "2026-09-18T07:41:41Z", "origin_kind": "system-dev-planner", "source_digest": "43c180442d323619da959ba559d05c4cc62b59a5e1b0c231fe45d360537324fe", "source_path": ".dev-graph/plans/feature-package-feat-subscriptions-screen/task-specs/phase-12-documentation-operations.md", "source_plugin": "system-dev-planner", "source_version": "0.1.0"}
created_at: "2026-09-18T07:41:41Z"
updated_at: "2026-09-18T07:41:41Z"
depends_on: ["SYS-SUBS-P11"]
...
resource_scope: ["docs/subscriptions-screen.md", "docs/data-schema.md", "docs/design-system.md", "docs/ui-decisions.md"]
purpose: null
goal: null
scope_in: null
scope_out: null
...
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-subscriptions-screen/sys-subs-p12.md", "confidence": 0.95}]
...
- parent_feature: feat-subscriptions-screen
- phase_ref: P12
- classification: confidence 0.95、reason 単一責務の実行タスクであり、artifact_kind は task 以外に取り得ない、candidate tasks/feat-subscriptions-screen/sys-subs-p12.md
...
見直し候補の規則・閾値・定型文、カテゴリ辞書、口座の手がかり語彙、migration 0043 の表定義、部品の使い方を docs へ最終同期する。

## 背景

規則と閾値が docs とテストの 2 か所にあるとき、片方だけ直されると食い違う。docs には値と根拠のテスト名を並べて書く。
...
- Documentation: applicable: 4 本の docs を同期する
- Operations: applicable: migration 0043 の適用手順と確認方法を書く
...
- PR body contract: dev-graph graph_node_id SYS-SUBS-P12 を本文に記載し、default branch を対象にする
- Ownership boundary: system-dev-planner は intent を宣言するのみで、dev-graph が実際の mutation/reconciliation を行う

## Branch and worktree execution

- Branch: dev-graph 登録後に C15 が devgraph/SYS-SUBS-P12 として割り当てる。system-dev-planner は事前割り当てを行わない
- Worktree lease: 実装着手前に SYS-SUBS-P12 の worktree lease を claim し、heartbeat/release を行う
- Parallel safety: depends_on (SYS-SUBS-P11) が完了し、write_scope が他の active lease と重複しないこと
