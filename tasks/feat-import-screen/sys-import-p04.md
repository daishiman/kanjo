---
graph_node_id: "SYS-IMPORT-P04"
artifact_kind: "task"
artifact_subtypes: []
title: "core 境界値・上限の字面・API 契約・migration・DOM の失敗テスト先行作成"
...
file_path: "tasks/feat-import-screen/sys-import-p04.md"
template_id: "task"
...
source_lineage: {"imported_at": "2026-09-21T23:18:31Z", "origin_kind": "system-dev-planner", "source_digest": "fa224df0033b3c1ab8a8b635f5b81cf08198f48aca9f810af472bf695fd896b4", "source_path": ".dev-graph/plans/feature-package-feat-import-screen/task-specs/phase-04-test-design.md", "source_plugin": "system-dev-planner", "source_version": "0.1.0"}
...
resource_scope: ["packages/core/test/import-screen.test.ts", "packages/api/src/import-screen.integration.test.ts", "packages/api/src/import-migration-0050.test.ts", "packages/web/src/pages/import/import-screen.dom.test.tsx", "packages/api/src/import-limits-literal.test.ts"]
purpose: null
goal: null
scope_in: null
scope_out: null
...
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-import-screen/sys-import-p04.md", "confidence": 0.95}]
...
# core 境界値・上限の字面・API 契約・migration・DOM の失敗テスト先行作成
