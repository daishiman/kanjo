...
iteration: null
owners: ["daishiman"]
tags: ["mf-business-classification", "p06"]
file_path: "tasks/feat-mf-business-classification/sys-mfbiz-p06.md"
template_id: "task"
...
source_lineage: {"imported_at": "2026-09-10T06:39:55Z", "origin_kind": "system-dev-planner", "source_digest": "4507ede5d42da3ab87c482019d1db916c73abdaa2d6c507811a6dc7fa27e900a", "source_path": ".dev-graph/plans/feature-package-feat-mf-business-classification/task-specs/phase-06-test-run.md", "source_plugin": "system-dev-planner", "source_version": "0.1.0"}
created_at: "2026-09-10T06:39:55Z"
updated_at: "2026-09-10T06:39:55Z"
depends_on: ["SYS-MFBIZ-P05"]
related_nodes: ["spec-mf-business-classification", "arch-mf-business-backend", "arch-mf-business-maintenance-ops"]
resource_scope: ["docs/mf-business-classification/test-run.md"]
purpose: null
goal: null
scope_in: null
scope_out: null
...
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-mf-business-classification/sys-mfbiz-p06.md", "confidence": 0.95}]
...
再現可能なコマンドと終了状態を test-run に記録する。
...
P05 の実装。依存IDは frontmatter の `depends_on` を参照。
