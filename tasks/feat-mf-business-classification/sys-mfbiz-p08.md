...
iteration: null
owners: ["daishiman"]
tags: ["mf-business-classification", "p08"]
file_path: "tasks/feat-mf-business-classification/sys-mfbiz-p08.md"
template_id: "task"
...
source_lineage: {"imported_at": "2026-09-10T06:39:55Z", "origin_kind": "system-dev-planner", "source_digest": "eb49df56a5969cce61320f180273544ec7fda12cd1059a25cb95309c25948d7d", "source_path": ".dev-graph/plans/feature-package-feat-mf-business-classification/task-specs/phase-08-refactoring-migration.md", "source_plugin": "system-dev-planner", "source_version": "0.1.0"}
created_at: "2026-09-10T06:39:55Z"
updated_at: "2026-09-10T06:39:55Z"
depends_on: ["SYS-MFBIZ-P07"]
related_nodes: ["spec-mf-business-classification", "arch-mf-business-backend"]
resource_scope: ["packages/core/src/total-cashflow.ts", "docs/mf-business-classification/refactoring.md"]
purpose: null
goal: null
scope_in: null
scope_out: null
...
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-mf-business-classification/sys-mfbiz-p08.md", "confidence": 0.95}]
...
旧分類経路・重複型を除き refactoring に記録する。
...
P07 の受入結果。依存IDは frontmatter の `depends_on` を参照。
...
total-cashflowはresolveTxへ間接依存しwebはcore型を共有する。
