---
graph_node_id: "SYS-DIAGNOSIS-SCREEN-P05"
artifact_kind: "task"
artifact_subtypes: []
title: "検知器レジストリ・健全性スコア・2 endpoint・D1 新表・診断画面の実装"
...
file_path: "tasks/feat-diagnosis-screen/sys-diagnosis-screen-p05.md"
template_id: "task"
...
resource_scope: ["packages/core/src", "packages/api/src/routes", "migrations", "packages/web/src/pages/analysis", "packages/web/src"]
purpose: null
goal: null
scope_in: null
scope_out: null
...
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-diagnosis-screen/sys-diagnosis-screen-p05.md", "confidence": 1.0}]
