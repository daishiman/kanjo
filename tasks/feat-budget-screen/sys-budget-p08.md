---
graph_node_id: "SYS-BUDGET-P08"
artifact_kind: "task"
artifact_subtypes: []
title: "旧 Budget.tsx 参照・重複判定ロジック・budgets 表書き換え有無の読取専用監査"
...
file_path: "tasks/feat-budget-screen/sys-budget-p08.md"
template_id: "task"
...
source_lineage: {"imported_at": "2026-09-21T14:49:37Z", "origin_kind": "system-dev-planner", "source_digest": "feeba81f7451b59df51e3830e506ace921410eada67b4f6494010ec6bf19a067", "source_path": ".dev-graph/plans/feature-package-feat-budget-screen/task-specs/phase-08-refactoring-migration.md", "source_plugin": "system-dev-planner", "source_version": "0.1.0"}
created_at: "2026-09-21T14:49:37Z"
updated_at: "2026-09-21T14:49:37Z"
depends_on: ["SYS-BUDGET-P07"]
...
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-budget-screen/sys-budget-p08.md", "confidence": 0.95}]
...
# 旧 Budget.tsx 参照・重複判定ロジック・budgets 表書き換え有無の読取専用監査
...
旧 pages/Budget.tsx への参照が残っていないこと、算出ロジックの重複が無いこと、migration 0050 が既存 budgets 行を書き換えていないことを読取専用で監査する。
...
- migration 0050 適用前後で既存 budgets 表の行数と内容が変わらないこと (UPDATE・DELETE が 0 件) が確認されている。
