---
graph_node_id: "SYS-TRENDS-P01"
artifact_kind: "task"
artifact_subtypes: []
title: "要件ベースライン確定と architecture の path 表記の対応表"
...
file_path: "tasks/feat-trends-screen/sys-trends-p01.md"
template_id: "task"
...
source_lineage: {"imported_at": "2026-09-16T10:30:02Z", "origin_kind": "system-dev-planner", "source_digest": "ad9f046d57b0189604f64f5669609c5feb4462b9f403d3f31a053df4268349b4", "source_path": ".dev-graph/plans/feature-package-feat-trends-screen/task-specs/phase-01-requirements.md", "source_plugin": "system-dev-planner", "source_version": "0.1.0"}
...
resource_scope: ["docs/trends-screen/requirements-baseline.md"]
purpose: null
goal: null
scope_in: null
scope_out: null
...
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-trends-screen/sys-trends-p01.md", "confidence": 0.95}]
...
# 要件ベースライン確定と architecture の path 表記の対応表
...
- requirements-baseline.md には実装中に確定した FR13 (保存値が無い初回期間は直近1年、I1 の具体化) を追記済み。
