---
graph_node_id: "SYS-CLASSIFY-P12"
artifact_kind: "task"
artifact_subtypes: []
title: "分類ステータス・信頼度・ルール適用の規則と Q-1〜Q-5・保存フィルタ / 履歴のバックアップ方針の docs 最終同期"
...
file_path: "tasks/feat-classify-screen/sys-classify-p12.md"
template_id: "task"
...
resource_scope: ["docs/classify-screen/design-decisions.md", "docs/data-schema.md", "docs/ui-decisions.md"]
purpose: null
goal: null
scope_in: null
scope_out: null
...
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-classify-screen/sys-classify-p12.md", "confidence": 0.95}]
...
# 分類ステータス・信頼度・ルール適用の規則と Q-1〜Q-5・保存フィルタ / 履歴のバックアップ方針の docs 最終同期
