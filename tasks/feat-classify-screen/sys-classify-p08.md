---
graph_node_id: "SYS-CLASSIFY-P08"
artifact_kind: "task"
artifact_subtypes: []
title: "旧 Classify.tsx 参照・証憑欄・重複判定ロジックの読取専用監査"
...
file_path: "tasks/feat-classify-screen/sys-classify-p08.md"
template_id: "task"
...
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-classify-screen/sys-classify-p08.md", "confidence": 0.95}]
...
# 旧 Classify.tsx 参照・証憑欄・重複判定ロジックの読取専用監査
