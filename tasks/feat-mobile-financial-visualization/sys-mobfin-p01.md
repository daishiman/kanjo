...
artifact_kind: task
artifact_subtypes: []
title: モバイル財務表示の要求基線とfigure inventoryを確定
...
updated_at: '2026-08-30T12:06:05Z'
depends_on: []
related_nodes:
...
resource_scope:
- .dev-graph/plans/feature-package-feat-mobile-financial-visualization/evidence/phase-01-figure-inventory.md
parent_feature: feat-mobile-financial-visualization
feature_package_id: feature-package/feat-mobile-financial-visualization
phase_ref: P01
file_path: tasks/feat-mobile-financial-visualization/sys-mobfin-p01.md
template_id: task
...
source_lineage:
  ...
  source_path: .dev-graph/plans/feature-package-feat-mobile-financial-visualization/task-specs/phase-01-requirements.md
  source_version: 0.1.0
  source_digest: e4745a1c30c978feee27da5d14e3bcd1bd0dfbbca3f55483b63524009796ceda
  imported_at: '2026-08-30T10:09:51Z'
classification_confidence: 1
classification_reason: 全routeの財務figure、KPI、高密度表を受入条件へ結ぶ要求基線の確定作業。
classification_candidates:
- artifact_kind: task
  confidence: 1
  candidate_path: tasks/feat-mobile-financial-visualization/sys-mobfin-p01.md
github_publication:
  mode: local_only
  project_aliases: []
  labels: []
...
beads_linkage:
  bd_issue_id: kanjo-dy9.1
  linked_at: '2026-08-30T12:06:05Z'
  sync_state: synced
  github_mirror: null
...
purpose: 全routeの財務chart、figure、KPI、高密度表を同じ粒度で棚卸しし、desktopと狭幅の意味情報差分を実装前の要求基線として確定する。
goal: モバイル財務表示の要求基線とfigure inventoryを確定を、受入条件と検証可能な証跡を満たした状態で完了する。
scope_in:
- .dev-graph/plans/feature-package-feat-mobile-financial-visualization/evidence/phase-01-figure-inventory.md
scope_out:
...
acceptance:
- 'Automated commands: `rg -n "Chart|financial-figure|report-chart|canvas|table className"
  packages/web/src`'
...
> **この文書が正本。** `.dev-graph/plans/feature-package-feat-mobile-financial-visualization/task-specs/phase-01-requirements.md` は promotion 時点の staging snapshot です。promotion 後の更新は本書へ記録します。
