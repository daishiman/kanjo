...
iteration: null
owners: ["daishiman"]
tags: ["improvement", "p11", "evidence"]
file_path: "tasks/feat-improvement-screen/sys-impscr-p11.md"
template_id: "task"
...
resource_scope: ["docs/improvement-screen/evidence.md"]
purpose: null
goal: null
scope_in: null
scope_out: null
...
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-improvement-screen/sys-impscr-p11.md", "confidence": 0.95}]
...
- parent_feature: feat-improvement-screen
- phase_ref: P11
- classification: confidence 0.95、reason 単一責務の実行タスクであり、artifact_kind は task 以外に取り得ない、candidate tasks/feat-improvement-screen/sys-impscr-p11.md
...
P04〜P10 の証跡をコミットとコマンド付きの索引にまとめる。

## 背景

後から同じ判定を再現できるよう、証跡ごとにコミットと実行コマンドを残す。
...
- Security: N/A: 索引のみ
- Quality: applicable: 証跡の再現性を確かめる
...
- Produced artifacts:
- docs/improvement-screen/evidence.md
- Consumed artifacts:
...
- PR body contract: dev-graph graph_node_id SYS-IMPSCR-P11 を本文に記載し、default branch を対象にする
- Ownership boundary: system-dev-planner は intent を宣言するのみで、dev-graph が実際の mutation/reconciliation を行う

## Branch and worktree execution

- Branch: dev-graph 登録後に C15 が devgraph/SYS-IMPSCR-P11 として割り当てる。system-dev-planner は事前割り当てを行わない
- Worktree lease: 実装着手前に SYS-IMPSCR-P11 の worktree lease を claim し、heartbeat/release を行う
- Parallel safety: depends_on (SYS-IMPSCR-P10) が完了し、write_scope が他の active lease と重複しないこと
