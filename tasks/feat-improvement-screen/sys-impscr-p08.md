---
graph_node_id: "SYS-IMPSCR-P08"
artifact_kind: "task"
artifact_subtypes: []
title: "導出とマスクの重複・削除中の行の読取漏れ・旧参照の読取専用監査"
...
file_path: "tasks/feat-improvement-screen/sys-impscr-p08.md"
template_id: "task"
...
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-improvement-screen/sys-impscr-p08.md", "confidence": 0.95}]
...
# 導出とマスクの重複・削除中の行の読取漏れ・旧参照の読取専用監査
