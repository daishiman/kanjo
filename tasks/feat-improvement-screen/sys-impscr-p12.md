---
graph_node_id: "SYS-IMPSCR-P12"
artifact_kind: "task"
artifact_subtypes: []
title: "状態・番号・マスク・削除と復元・夜間消去の規則表と docs/improvement-request.md・runbook の最終同期"
...
file_path: "tasks/feat-improvement-screen/sys-impscr-p12.md"
template_id: "task"
...
resource_scope: ["docs/improvement-screen/rules.md", "docs/improvement-screen/design-decisions.md", "docs/improvement-request.md", "docs/data-schema.md", "docs/ui-decisions.md"]
purpose: null
goal: null
scope_in: null
scope_out: null
...
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-improvement-screen/sys-impscr-p12.md", "confidence": 0.95}]
...
# 状態・番号・マスク・削除と復元・夜間消去の規則表と docs/improvement-request.md・runbook の最終同期
