---
graph_node_id: "SYS-TCSCREEN-P11"
artifact_kind: "task"
artifact_subtypes: []
title: "証跡索引の作成"
...
iteration: null
owners: ["daishiman"]
tags: ["total-cashflow-screen", "p11", "evidence"]
file_path: "tasks/feat-total-cashflow-screen/sys-tcscreen-p11.md"
template_id: "task"
...
resource_scope: ["docs/total-cashflow-screen/evidence.md"]
purpose: null
goal: null
scope_in: null
scope_out: null
...
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-total-cashflow-screen/sys-tcscreen-p11.md", "confidence": 0.95}]
...
- parent_feature: feat-total-cashflow-screen
- phase_ref: P11
- classification: confidence 0.95、reason 単一責務の実行タスクであり、artifact_kind は task 以外に取り得ない、candidate tasks/feat-total-cashflow-screen/sys-tcscreen-p11.md
...
P01..P10 の記録・テスト名・コマンド出力の要点を AC と FR から引ける索引にまとめる。

## 背景

月次クローズの判定規則は後から見直されやすく、どの証跡で固定したかを 1 か所から辿れる必要がある。
...
- Entry gate: SYS-TCSCREEN-P10 が完了していること
...
- Quality: applicable: AC と FR から証跡への対応表を作る
- Documentation: N/A: 本 phase は文書の作成だけを行い、この層のコードを変更しない
- Operations: applicable: 再検証のコマンドを併記する
...
- AC-001..AC-006 と FR-001..FR-008 の全件が、少なくとも 1 つの証跡 (文書またはテスト) に対応づいている。
...
- PR body contract: dev-graph graph_node_id SYS-TCSCREEN-P11 を本文に記載し、default branch を対象にする
- Ownership boundary: system-dev-planner は intent を宣言するのみで、dev-graph が実際の mutation/reconciliation を行う

## Branch and worktree execution

- Branch: dev-graph 登録後に C15 が devgraph/SYS-TCSCREEN-P11 として割り当てる。system-dev-planner は事前割り当てを行わない
- Worktree lease: 実装着手前に SYS-TCSCREEN-P11 の worktree lease を claim し、heartbeat/release を行う
- Parallel safety: depends_on (SYS-TCSCREEN-P10) が完了し、write_scope が他の active lease と重複しないこと
...
- Rollback trigger and steps: docs/total-cashflow-screen/evidence.md の追加コミットを revert する。
