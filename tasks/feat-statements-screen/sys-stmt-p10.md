...
iteration: null
owners: ["daishiman"]
tags: ["statements-screen", "p10", "final-review"]
file_path: "tasks/feat-statements-screen/sys-stmt-p10.md"
template_id: "task"
...
source_lineage: {"imported_at": "2026-09-19T12:35:04Z", "origin_kind": "system-dev-planner", "source_digest": "b7b5463d81396f3733f71694ba174d935c886841941c232029b6574add8f6eb1", "source_path": ".dev-graph/plans/feature-package-feat-statements-screen/task-specs/phase-10-final-review.md", "source_plugin": "system-dev-planner", "source_version": "0.1.0"}
created_at: "2026-09-19T12:35:04Z"
updated_at: '2026-09-19T12:47:53Z'
depends_on: ["SYS-STMT-P09"]
...
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-statements-screen/sys-stmt-p10.md", "confidence": 0.95}]
tracker_binding: "beads"
beads_linkage:
  bd_issue_id: kanjo-oju.10
  linked_at: '2026-09-19T12:47:53Z'
  sync_state: synced
  github_mirror: null
...
- parent_feature: feat-statements-screen
- phase_ref: P10
- classification: confidence 0.95、reason 単一責務の実行タスクであり、artifact_kind は task 以外に取り得ない、candidate tasks/feat-statements-screen/sys-stmt-p10.md
...
P01 から P09 の成果物を、仕様と設計に照らして実装者と別の視点でレビューし、残る食い違いを follow-up に切り出す。

## 背景

同じ文脈で作った実装とテストは同じ思い込みを共有する。受入が PASS でも、区分対応表の読み方や前月末比の定義のように仕様の意図と違う読み方をしている箇所は独立レビューでしか見つからない。
...
- PR body contract: dev-graph graph_node_id SYS-STMT-P10 を本文に記載し、default branch を対象にする
- Ownership boundary: system-dev-planner は intent を宣言するのみで、dev-graph が実際の mutation/reconciliation を行う

## Branch and worktree execution

- Branch: dev-graph 登録後に C15 が devgraph/SYS-STMT-P10 として割り当てる。system-dev-planner は事前割り当てを行わない
- Worktree lease: 実装着手前に SYS-STMT-P10 の worktree lease を claim し、heartbeat/release を行う
- Parallel safety: depends_on (SYS-STMT-P09) が完了し、write_scope が他の active lease と重複しないこと
