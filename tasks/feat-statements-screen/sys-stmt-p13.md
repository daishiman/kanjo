---
graph_node_id: "SYS-STMT-P13"
artifact_kind: "task"
artifact_subtypes: []
title: "単一 PR での配信と migration 0046 の本番適用"
...
file_path: "tasks/feat-statements-screen/sys-stmt-p13.md"
template_id: "task"
...
resource_scope: ["migrations/0046_liability_status.sql", "docs/evidence/"]
purpose: null
goal: null
scope_in: null
scope_out: null
...
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-statements-screen/sys-stmt-p13.md", "confidence": 0.95}]
tracker_binding: "beads"
beads_linkage:
  bd_issue_id: kanjo-oju.13
  linked_at: '2026-09-19T12:47:57Z'
  sync_state: synced
  github_mirror: null
...
# 単一 PR での配信と migration 0046 の本番適用
...
単一の PR で default branch へ配信し、migration 0046 の適用から Deploy の順を守って本番へ反映し、クローズアウトする。
...
- Data: applicable: 本番で migration 0046 を適用し、既存行が変わらないことを確かめる
...
- Rollback trigger and steps: 画面と API の変更を revert して再 Deploy する。migration 0046 は追加のみのため巻き戻さない。
