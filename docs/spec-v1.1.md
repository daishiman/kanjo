...
| P3 | 統計診断 | `/diagnosis` | シグナルと判定基準を見て対応すべき科目を決める |
...
| P14 | 支出トレンド | `/trends` | 事業・家計の支出を並べ、次に手を打つ科目を決める |
...
- **ナビゲーション(全ページ共通)**: 17画面のルート・表示名・1タスク文は1つのmetadataを正本とし、ルート定義とナビで共用する。現在ページを強調する
