-- Migration number: 0053  設定の変更履歴 (追加のみ)
--
-- 0053_settings_change_log.sql : 設定の変更 1 件ごとの前後の値。右パネルの最終更新・元に戻す・revision の起点。
...
-- 0051 で移した集計ルールを『システム』の履歴として残す。現金上書き・名義・統計の既存値の履歴は作らない
