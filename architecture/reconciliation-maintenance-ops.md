...
confirmation_evidence: {"evaluator": "system-spec-harness:assign-system-spec-completeness-evaluator", "evidence_ref": "system-spec/completeness-findings.json", "evaluated_digest": "8d99018c173d997d4371e57fbea80afd8d66a3ea442d85b108d2e1db7dbcdc1c"}
source_lineage: {"origin_kind": "system-spec-harness", "source_plugin": "system-spec-harness", "source_path": "system-spec/maintenance-ops.md", "source_version": "0.1.14", "source_digest": "8d99018c173d997d4371e57fbea80afd8d66a3ea442d85b108d2e1db7dbcdc1c", "imported_at": "2026-09-15T10:39:59Z"}
...
照合画面 — 判定規則の境界値テストと回帰検査。`system-spec/maintenance-ops.md` は承認時入力、本書は運用制約を持つ。現行の機能仕様の正本は `specs/spec-reconciliation.md`。
